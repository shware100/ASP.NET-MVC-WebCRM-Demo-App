    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebCRM.DAL.WebCRMDBContext>
    {
        ...
        protected override void Seed(WebCRM.DAL.WebCRMDBContext context)
        {
            ...
            context.ActivityHistory.AddOrUpdate(
                a => a.ID,
                new ActivityHistory { ID = 1, CompanyID = 1, ContactID = 1, ActivityType = ActivityType.Call, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 001 Event 1", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 2, CompanyID = 1, ContactID = 2, ActivityType = ActivityType.Meeting, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 001 Event 2", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 3, CompanyID = 1, ContactID = 3, ActivityType = ActivityType.Task, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 001 Event 3", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },

                new ActivityHistory { ID = 4, CompanyID = 2, ContactID = 4, ActivityType = ActivityType.Call, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 002 Event 1", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 5, CompanyID = 2, ContactID = 5, ActivityType = ActivityType.Meeting, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 002 Event 2", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 6, CompanyID = 2, ContactID = 6, ActivityType = ActivityType.Task, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 002 Event 3", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },

                new ActivityHistory { ID = 7, CompanyID = 3, ContactID = 7, ActivityType = ActivityType.Call, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 003 Event 1", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 8, CompanyID = 3, ContactID = 8, ActivityType = ActivityType.Meeting, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 003 Event 2", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 9, CompanyID = 3, ContactID = 9, ActivityType = ActivityType.Task, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 003 Event 3", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },

                new ActivityHistory { ID = 10, CompanyID = 4, ContactID = 10, ActivityType = ActivityType.Call, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 004 Event 1", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 11, CompanyID = 4, ContactID = 11, ActivityType = ActivityType.Meeting, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 004 Event 2", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 12, CompanyID = 4, ContactID = 12, ActivityType = ActivityType.Task, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 004 Event 3", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },

                new ActivityHistory { ID = 13, CompanyID = 5, ContactID = 13, ActivityType = ActivityType.Call, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 005 Event 1", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 14, CompanyID = 5, ContactID = 14, ActivityType = ActivityType.Meeting, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 005 Event 2", CreatedAt = DateTime.Now, Updatedat = DateTime.Now },
                new ActivityHistory { ID = 15, CompanyID = 5, ContactID = 15, ActivityType = ActivityType.Task, ActivityStatus = ActivityStatus.Active, ActivityDate = DateTime.Now, Subject = "Company 005 Event 3", CreatedAt = DateTime.Now, Updatedat = DateTime.Now }
